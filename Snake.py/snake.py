...
if (check_errors[1] > 0):
    print("Errror" + check_errors[1])
else :
    print("jeux parfaitement installés")
...
def init_vars():
    global head_pos, snoke_body, food_pos, food_spawn, score, direction 
    direction = "RIGHT"
    head_pos = [120,60]
    snake_body = [[120,60]]
...
def show_score(choice, color, font, size):
    ...
    score_surface = score_front.render("Score:" + str(score), True, color)
